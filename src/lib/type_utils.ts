...
export type UnknownMap = Record<string, any>;
export function asMap(value: any): {[key: string]: any} | undefined;
export function asMap(value: any, defaultValue: UnknownMap): UnknownMap;
export function asMap(value: any, defaultValue?: UnknownMap): UnknownMap | undefined {
  // eslint-disable-next-line no-null/no-null
  return typeof value === 'object' && value !== null ? (value as UnknownMap) : defaultValue;
}
...
export type Brand<Type, Name> = Type & {__brand: Name}; // eslint-disable-line @typescript-eslint/naming-convention
